...
module tb_axi_fifo;
    ...
    initial begin
        ...
        s_valid = 1;
        s_data = 8'h01; @(posedge clk); #1;
        s_data = 8'h02; @(posedge clk); #1;
        s_data = 8'h03; @(posedge clk); #1;
        s_data = 8'h04; @(posedge clk); #1;
        s_valid = 0;
        @(posedge clk); #1;
        check_flag(full, 1, 6);
        ...
        m_ready = 1;
        check_eq(m_data, 8'h01, 8); @(posedge clk); #1;
        check_eq(m_data, 8'h02, 9); @(posedge clk); #1;
        check_eq(m_data, 8'h03, 10); @(posedge clk); #1;
        check_eq(m_data, 8'h04, 11); @(posedge clk); #1;
        m_ready = 0;
        @(posedge clk); #1;
        check_flag(empty, 1, 12);

        // Test 13-14: simultaneous enq+deq
        s_valid = 1; s_data = 8'hBB; @(posedge clk); #1;
        s_data = 8'hCC; @(posedge clk); #1;
        s_valid = 0; @(posedge clk); #1;
        ...
        s_valid = 1; s_data = 8'hEE; @(posedge clk); #1; s_valid = 0;
        m_ready = 0;
        repeat(5) @(posedge clk); #1;
        check_flag(m_valid, 1, 15);
        m_ready = 1;
        check_eq(m_data, 8'hEE, 16); @(posedge clk); #1;
        m_ready = 0;

        // Test 17-20: multiple enqueue and dequeue cycles
        rst = 1; @(posedge clk); #1; rst = 0; @(posedge clk); #1;
        s_valid = 1;
        s_data = 8'h11; @(posedge clk); #1;
        s_data = 8'h22; @(posedge clk); #1;
        s_data = 8'h33; @(posedge clk); #1;
        s_valid = 0; @(posedge clk); #1;
        m_ready = 1;
        check_eq(m_data, 8'h11, 17); @(posedge clk); #1;
        check_eq(m_data, 8'h22, 18); @(posedge clk); #1;
        check_eq(m_data, 8'h33, 19); @(posedge clk); #1;
        m_ready = 0;
        @(posedge clk); #1;
        ...
        rst = 1; @(posedge clk); #1; rst = 0; @(posedge clk); #1;
        s_valid = 1;
        s_data = 8'hAA; @(posedge clk); #1;
        s_data = 8'hBB; @(posedge clk); #1;
        s_data = 8'hCC; @(posedge clk); #1;
        s_data = 8'hDD; @(posedge clk); #1;
        s_valid = 0; @(posedge clk); #1;
        m_ready = 1;
        check_eq(m_data, 8'hAA, 21); @(posedge clk); #1;
        check_eq(m_data, 8'hBB, 22); @(posedge clk); #1;
        m_ready = 0; s_valid = 1;
        s_data = 8'hEE; @(posedge clk); #1;
        s_valid = 0;
        m_ready = 1;
        check_eq(m_data, 8'hCC, 23); @(posedge clk); #1;
        check_eq(m_data, 8'hDD, 24); @(posedge clk); #1;
        check_eq(m_data, 8'hEE, 241); @(posedge clk); #1;
        m_ready = 0;

        // Test 25-28: Rapid push/pop pattern
        rst = 1; @(posedge clk); #1; rst = 0; @(posedge clk); #1;
        s_valid = 1; m_ready = 0;
        s_data = 8'h55; @(posedge clk); #1;
        s_data = 8'h66; m_ready = 1;
        check_eq(m_data, 8'h55, 25); @(posedge clk); #1;
        s_data = 8'h77;
        check_eq(m_data, 8'h66, 26); @(posedge clk); #1;
        s_data = 8'h88;
        check_eq(m_data, 8'h77, 27); @(posedge clk); #1;
        s_valid = 0;
        check_eq(m_data, 8'h88, 28); @(posedge clk); #1;
        m_ready = 0;
